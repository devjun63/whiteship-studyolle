...
@Component
// bean과 bean들만 의존성 주입 받을 수 있기 때문에 component어노테이션 선언
...
public class SignUpFormValidator implements Validator {
    ...
    /*
    @RequiredArgsConstructor ->
    create private final type member variable constructor
    ...
    @Override
    public void validate(Object object, Errors errors) {// object가 signUpForm에서 들어온 값을 가지고 있는 객체
